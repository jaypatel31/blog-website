        ...
        <div className="md:px-20">
        {
            (post)?(
                ...
                <div className="text-gray-500 md:flex my-5">
                    <Link to={`/?username=${post.user_id._id}`}>
                        <div className="cursor-pointer">Author: <span className="font-semibold">{post.user_id.name}</span></div>
                    </Link>
